...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('developer.brands.index', compact('brands', 'edit_brand'));
    }
    ...
    {
        return view('developer.brands.create');
    }
    ...
    {
        return view('developer.brands.show', compact('brand'));
    }
    ...
    public function edit(Request $request, Brand $brand)
    {
        ...
        return redirect()->route('developer.brand.index');
    }

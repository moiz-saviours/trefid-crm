...
//            'agent_type' => 'required|string|in:developers,users',
...
//            'agent_type.in' => 'The agent type must be either "developers" or "users".',
        ...
        return redirect()->route('developer.invoice.index')->with('success', 'Invoice created successfully.');
    }
    ...
    {
        return view('developer.invoices.show', compact('invoice'));
    }
...
//            'agent_type.in' => 'The agent type must be either "admins" or "users".',
        ...
        return redirect()->route('developer.invoice.index')->with('success', 'Invoice updated successfully.');
    }

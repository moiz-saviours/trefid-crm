...
class LeadController extends Controller
{
    ...
    {
        $leads = Lead::all();
        return view('developer.leads.index', compact('leads'));
    }
    ...
    public function create()
    {
        ...
        $clients = Client::all();
        return view('developer.leads.create', compact('brands', 'teams', 'clients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('developer.lead.index')->with('success', 'Lead created successfully.');
    }
    ...
    {
        return view('developer.leads.show', compact('lead'));
    }
    ...
    public function edit(Lead $lead)
    {
        ...
        $teams = Cache::remember('teams_list', config('cache.durations.short_lived'), fn() => Team::all());
        $clients = Client::all();
        return view('developer.leads.edit', compact('lead', 'brands', 'teams', 'clients'));
    }
    ...
    public function update(Request $request, Lead $lead)
    {
        ...
        return redirect()->route('developer.lead.index')->with('success', 'Lead updated successfully.');
    }

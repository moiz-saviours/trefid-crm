...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('developer.payments.index', compact('payments'));
    }
    ...
    public function create()
    {
        ...
        return view('developer.payments.create', compact('brands', 'teams', 'agents', 'clients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('developer.payment.index')->with('success', 'Payment created successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit(Payment $payment)
    {
        ...
        $agents = User::where('status', 1)->get();
        $clients = CustomerContact::where('status', 1)->get();
        return view('developer.payments.edit', compact('payment', 'brands', 'teams', 'agents', 'clients'));
    }
    ...
    public function update(Request $request, Payment $payment)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('developer.payment.index')->with('success', 'Payment updated successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->withErrors(['error' => $e->getMessage()])->withInput();
        }

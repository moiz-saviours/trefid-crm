...
{{--        <a href="{{ route('admin.lead-status.index') }}">Lead Status</a>--}}
{{--    </li>--}}
{{--    <li class="breadcrumb-item text-sm text-white active" aria-current="page">--}}
{{--        <a href="{{ route('admin.lead-status.create') }}">Create</a>--}}
{{--    </li>--}}
{{--@endpush--}}
...
{{--                                <a href="{{ route('admin.lead-status.index') }}" class="btn btn-secondary">Cancel</a>--}}
{{--                            </div>--}}
{{--                        </form>--}}
{{--                    </div>--}}
{{--                </div>--}}

...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm text-white active" aria-current="page"><a
            href="{{route('developer.lead.index')}}">Lead</a>
    </li>
@endpush
@section('content')
    @push('style')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <a href="{{ route('developer.lead.create') }}" class="btn btn-secondary float-end rounded-pill"><i
                                ...
                                @foreach($leads as $lead)
                                    <tr id="tr-{{$lead->id}}">
                                        ...
                                        <td class="align-middle text-center table-actions">
                                            <a href="{{ route('developer.lead.edit', [$lead->id]) }}"

...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm active" aria-current="page"><a
            href="{{route('developer.payment.index')}}">Payment</a>
    </li>
@endpush
@section('content')
    @push('style')
        @include('developer.payments.style')
    @endpush
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <a href="{{ route('developer.payment.create') }}" class="btn btn-secondary float-end rounded-pill"><i
                                ...
                                @foreach($payments as $payment)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center table-actions">
                                            <a href="{{route('developer.payment.edit',[$payment->id])}}" data-id="{{ $payment->id }}"
...
{{--                                            </a>--}}
    ...
    @push('script')
        @include('developer.payments.script')
    @endpush
@endsection

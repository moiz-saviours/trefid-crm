<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-3 shadow border-radius-xl " id="navbarBlur"
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm"><a class="opacity-5 "
                                                       href="javascript:;">{{config('app.name','Crm')}}</a>
                </li>
                @stack('breadcrumb')
            </ol>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center p-1">
                    <a href="{{ route('developer.profile.edit') }}" class="nav-link font-weight-bold px-0">
                        <i class="fa fa-user me-sm-1"></i>
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center p-1">
                    <form method="POST" action="{{ route('developer.logout') }}" id="logout-form" class="d-none">
                        @csrf
                    </form>

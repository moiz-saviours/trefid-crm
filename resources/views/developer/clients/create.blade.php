...
@section('title','CustomerContact / Create')
@push('breadcrumb')
    ...
    <li class="breadcrumb-item text-sm text-white active" aria-current="page"><a
            href="{{route('developer.client.create')}}">Create</a></li>
@endpush
@section('content')
    @push('style')
                    ...
                    <div class="card-body">
                        <form action="{{ route('developer.client.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('developer.client.index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>

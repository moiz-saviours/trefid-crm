...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm text-white active" aria-current="page"><a
            href="{{route('developer.client.index')}}">Client</a>
    </li>
@endpush
@section('content')
    @push('style')
        @include('developer.clients.style')
    @endpush
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <a href="{{ route('developer.client.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-nowrap">
                                            @if(isset($client->brand))
                                                <a href="{{route('developer.brand.edit',[$client->brand->id])}}">{{ $client->brand->name }}</a>
                                        ...
                                        <td class="align-middle text-center text-nowrap">
                                            @if(isset($client->team))
                                                <a href="{{route('developer.team.edit',[$client->team->id])}}">{{ $client->team->name }}</a>
                                        ...
                                        <td class="align-middle text-center table-actions">
                                            <a href="{{ route('developer.client.edit', [$client->id]) }}"
    ...
    @push('script')
        @include('developer.clients.script')
    @endpush
@endsection

...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm active" aria-current="page"><a href="{{route('developer.brand.index')}}">Brand</a>
    </li>
@endpush
@section('content')
    @push('style')
        @include('developer.brands.style')
    @endpush
    ...
    <!-- Modal -->
    @include('developer.brands.create-modal')
    @include('developer.brands.edit-modal')

    @push('script')
        @include('developer.brands.script')
    @endpush
@endsection

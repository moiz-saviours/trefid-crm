...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm " aria-current="page"><a href="{{ route('developer.team.index') }}">Team</a></li>
    <li class="breadcrumb-item text-sm  active" aria-current="page"><a
            href="{{ route('developer.team.edit', [$team->id]) }}">Edit</a></li>
@endpush
@section('content')
    @push('style')
        @include('developer.teams.style')
    @endpush
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('developer.team.update', [$team->id]) }}" method="POST">
                            @csrf
                            <div class="row">
                                <!-- Left Column -->
                                <div class="col-md-6">
                            ...
                            <a href="{{ route('developer.team.index') }}" class="btn btn-danger">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    @push('script')
        @include('developer.teams.script')
    @endpush
@endsection

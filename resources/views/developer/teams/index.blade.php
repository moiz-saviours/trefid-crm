...
@push('breadcrumb')
    <li class="breadcrumb-item text-sm text-white active" aria-current="page"><a href="{{route('developer.team.index')}}">Team</a>
    </li>
@endpush
@section('content')
    @push('style')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <a href="{{ route('developer.team.create') }}" class="btn btn-secondary float-end rounded-pill"><i class="fas fa-plus"></i></a>
                    </div>
                                ...
                                @foreach($teams as $team)
                                    <tr id="tr-{{$team->id}}">
                                        ...
                                        <td class="align-middle text-center table-actions">
                                            <a href="{{ route('developer.team.edit', [$team->id]) }}"
